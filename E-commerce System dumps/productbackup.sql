...
--
-- Table structure for table `t_productbackup`
--

DROP TABLE IF EXISTS `t_productbackup`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_productbackup` (
  `product_id` int(11) NOT NULL,
  `product_name` varchar(45) DEFAULT NULL,
  `product_desp` varchar(45) DEFAULT NULL,
  `unit_price` varchar(45) DEFAULT NULL,
  `unitweight` varchar(45) DEFAULT NULL,
  `product_size` varchar(45) DEFAULT NULL,
  `categoy_id` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `t_productbackup`
--

LOCK TABLES `t_productbackup` WRITE;
/*!40000 ALTER TABLE `t_productbackup` DISABLE KEYS */;
INSERT INTO `t_productbackup` VALUES (1,'training_shoes','shoes','80','30','9 US','1'),(2,'sneakerboots','shoes','120','40','10 U','4'),(3,'hoodies','clothing','60','25','M','6'),(4,'jerseys','clothing','50','20','M','6'),(5,'t-shirts','clothing','50','20','M','6'),(6,'tank tops','clothing','55','10','L','2'),(7,'the miller','kit','150','10','NA','2'),(8,'the yogi','kit','150','10','NA','2'),(9,'football','sports','150','10','NA','1'),(11,'tennis racquet','sports','130','5','NA',NULL),(12,'bag_packs','sports','40','0','L',NULL),(13,'bag_packs','sports','40','0','L',NULL);
/*!40000 ALTER TABLE `t_productbackup` ENABLE KEYS */;
UNLOCK TABLES;
