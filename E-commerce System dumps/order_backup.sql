...
--
-- Dumping data for table `order_backup`
--

LOCK TABLES `order_backup` WRITE;
/*!40000 ALTER TABLE `order_backup` DISABLE KEYS */;
/*!40000 ALTER TABLE `order_backup` ENABLE KEYS */;
UNLOCK TABLES;
