...
CREATE TABLE `supplier_t` (
  ...
  KEY `person_id_fk1_idx` (`person_id`),
  CONSTRAINT `person_id_fk1` FOREIGN KEY (`person_id`) REFERENCES `person_t` (`person_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `supplier_t` VALUES (1,'smart fabrics',1),(2,'genuine leather',2),(3,'cool fibre',4),(4,'sparkling woods',3);
